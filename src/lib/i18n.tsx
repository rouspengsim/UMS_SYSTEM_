...
const dict: Dict = {
  ...
  no_classes_yet: { en: "No classes match this filter yet.", km: "មិនទាន់មានថ្នាក់ត្រូវនឹងតម្រងនេះ។" },
  ...
  search_students: { en: "Search by ID, name, major, or class…", km: "ស្វែងរកតាមលេខសម្គាល់ ឈ្មោះ ជំនាញ ឬថ្នាក់…" },
